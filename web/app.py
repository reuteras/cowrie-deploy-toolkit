...
CONFIG = {
    ...
    "yara_cache_db_path": os.getenv("YARA_CACHE_DB_PATH", "/tmp/yara-cache.db"),
    "geoip_db_path": os.getenv("GEOIP_CITY_DB", "/geoip/GeoLite2-City.mmdb"),
    "geoip_asn_path": os.getenv("GEOIP_ASN_DB", "/geoip/GeoLite2-ASN.mmdb"),
